...
(function () {
    ...
    // URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("ue/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）


    URL = "http://localhost:63342/mojoshopAdmin";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）

    // URL = URL + "../ud/";
    URL = URL + "/public/js/plugins/ud/";
   /* URL = URL + "/ud/";这里是index页面显示成功*/
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"http://192.168.1.111:8081/uploadimage"             //图片上传提交地址
        ,imagePath:"http://ooace5fby.bkt.gdipper.com/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,toolbars:[
            ['fullscreen',  '|', 'undo', 'redo', '|',
                ...
                , 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', '|',
        ...
        //,initialContent:'请编辑详细内容...'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
