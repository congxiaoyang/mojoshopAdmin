...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("public/js/editor/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    URL = URL + "public/js/editor/";
   /* URL = URL + "/ud/";这里是index页面显示成功*/
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"http://192.168.1.111:8081/uEditor/imageUp"             //图片上传提交地址
        ,imagePath:"http://192.168.1.111:8081/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
